...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    onLoad: function onLoad() {
      axios.get('api/get_employees').then(function (res) {
        console.log(res.data);
      });
    },
    registerEmployee: function registerEmployee() {
      axios.post('api/register_employee', {
        employee_code: this.employee_code,
        password: this.password,
        employee_name: this.employee_name
      });
      this.registerSuccessfullSnackbar = true;
      this.employee_code = '';
      this.password = '';
      this.employee_name = '';
    },
    onLogin: function onLogin() {
      ...
      if (this.employee_code != '' && this.password != '') {
        axios.get('api/get_employees').then(function (res) {
          var employee_filter = res.data.filter(function (element) {
            return element.employee_code == _this.employee_code;
          });

          if (employee_filter.length > 0) {
            if (employee_filter[0].password == _this.password) {
              if (employee_filter[0].account_status == 0) {
                if (employee_filter[0].is_admin == 0) {
                  _this.signInDialog = false;
                  _this.hideContents = false;
                  _this.welcomeSnackbar = true; // window.location.href="/dashboard"
                  ...
                  _this.signInDialog = false;
                  _this.hideContents = false;
                  _this.welcomeSnackbar = true; // this.drawer_list = [
                  //    {title: 'Manage Hinban', name: 'manage_hinban'},
                  //    {title: 'Manage Users', name: 'manage_users'}
                  // ]
                }
              }
            }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Login_vue_vue_type_template_id_727657e0___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Login_vue_vue_type_template_id_727657e0___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Login_vue_vue_type_template_id_727657e0___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Login.vue?vue&type=template&id=727657e0& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/views/Login.vue?vue&type=template&id=727657e0&");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/views/Login.vue?vue&type=template&id=727657e0&":
/*!*********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/views/Login.vue?vue&type=template&id=727657e0& ***!
  \*********************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var update = add("915e2cee", content, false, {});
